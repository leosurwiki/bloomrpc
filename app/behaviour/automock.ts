...
export function mockServiceMethods(
  ...
  return Object.keys(mockedMethodsPayloads).reduce(
    (methods: UntypedServiceImplementation, method: string) => {
 ...
 * Mock a field type
 */
export function mockTypeFields(
  type: Type,
...
function mockField(field: Field, stackDepth?: StackDepth): any {
  ...
  if (field.resolvedType instanceof Type) {
    if (field.resolvedType.name === "Any") {
      return { place_holder: "{{double click a message to fill}}" };
    }
